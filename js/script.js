var rowData = document.getElementById("food");
...
function closeSide() {
    var boxWidth = $(".side-menu .side-tab").outerWidth()
    $(".side-menu").animate({
        left: -boxWidth
    }, 500)
...
async function getMealDetails(mealID) {
    ...
    search.innerHTML = "";
    var respone = await fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${mealID}`);
    respone = await respone.json();
...
async function searchByName(term) {
    ...
    var response = await fetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=${term}`)
    response = await response.json()
...
async function searchByFLetter(term) {
    ...
    term == "" ? term = "a" : "";
    var response = await fetch(`https://www.themealdb.com/api/json/v1/1/search.php?f=${term}`)
    response = await response.json()
...
var nameInputTouched = false;
var emailInputTouched = false;
var phoneInputTouched = false;
var ageInputTouched = false;
var passwordInputTouched = false;
var repasswordInputTouched = false;
